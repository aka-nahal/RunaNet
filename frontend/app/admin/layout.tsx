...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <aside className="flex w-56 flex-shrink-0 flex-col border-r border-zinc-800 bg-zinc-900/50">
        <div className="flex items-center gap-2 border-b border-zinc-800 px-4 py-3">
          ...
          <div>
            <h1 className="text-sm font-semibold text-zinc-200">Notice Board</h1>
        ...
        <div className="mt-auto border-t border-zinc-800 p-2">
          <Link href="/" target="_blank"
            className="flex items-center gap-2.5 rounded-lg px-3 py-2 text-sm text-zinc-500 hover:bg-zinc-800 hover:text-zinc-300">
